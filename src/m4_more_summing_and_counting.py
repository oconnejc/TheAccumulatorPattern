...
def run_test_factorial():
    ...
    # ------------------------------------------------------------------
    # Test 3:
    answer_from_oracle = math.factorial(33)
    answer_from_my_code = factorial(33)
...
def run_test_count_cosines_from():
    ...
    # Test 3:
    expected = 0
    answer = count_cosines_from(1,100,1)
    ...
    # Test 6:
    expected = 1
    answer = count_cosines_from(7,7,.7)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 1.0833  # This is APPROXIMATELY the correct answer.
